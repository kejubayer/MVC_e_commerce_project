...
require_once __DIR__.'/../partials/_dashboard_header.php'; ?>


<div class="container">

    <form class="form-signin" action="/dashboard/add_product" method="post" enctype="multipart/form-data">
...
<?php require_once __DIR__.'/../partials/_dashboard_footer.php'; ?>